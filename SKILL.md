...
<body style="background:var(--bg-page);font-family:var(--font-family);margin:0;padding:20px;">
  ...
  <nav class="nav-topbar">
    <img class="nav-brand-logo" src="logos/logo-white.png" alt="JoinBright-Blue">
...
|------|--------------|-----------------|
| Brand assets | Two logo variants: `logo-default.png` (multi-color brand mark for light surfaces), `logo-white.png` (light-on-dark for dark backgrounds). Agents always render the brand logo in navigation bars of generated prototypes by default. | preview/brand-assets.html, logos/ directory |

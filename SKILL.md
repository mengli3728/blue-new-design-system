...
| Spacing scale | 11 steps from 2px (icon-text gaps) to 224px (default form control width at 1920px). Density rules: 10px between controls, 20px column/card gaps, 24px module spacing. | DESIGN.md §4, colors_and_type.css --space-* tokens |
| Border radius | 4 levels: 2px tags/badges, 4px buttons/inputs/table-cells, 8px modals/flyout-panels, 999px pills/status-dots/avatars. | DESIGN.md §4, colors_and_type.css --radius-* tokens |
